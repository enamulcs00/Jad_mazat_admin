...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AgmDirection, [{
        ...
        args: [{
    ...
    }], function () { return [{ type: GoogleMapsAPIWrapper }]; }, { constructor: [], gmapsApi: [], travelMode: [{
            type: Input
        }], transitOptions: [{
            type: Input
        }], drivingOptions: [{
            ...
            type: Output
        }], directionsService: [], directionsDisplay: [], waypointsMarker: [], isFirstChange: [], ngOnInit: [], ngOnChanges: [], ngOnDestroy: [], directionDraw: [], renderRoute: [{
            type: Input
        }], originMarker: [], origin: [{
            type: Input
        }], destinationMarker: [], destination: [{
            type: Input
        }], setMarker: [], infoWindow: [{
            type: Input
        }], removeMarkers: [], removeDirections: [], destroyMarkers: [], renderOptions: [{
            type: Input
        }], panel: [{
            type: Input
        }], markerOptions: [{
