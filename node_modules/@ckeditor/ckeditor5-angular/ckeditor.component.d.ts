...
export declare class CKEditorComponent implements AfterViewInit, OnDestroy, ControlValueAccessor {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<CKEditorComponent, "ckeditor", never, { 'config': "config", 'data': "data", 'tagName': "tagName", 'disabled': "disabled", 'editor': "editor", 'watchdog': "watchdog" }, { 'ready': "ready", 'change': "change", 'blur': "blur", 'focus': "focus", 'error': "error" }, never>;
}
