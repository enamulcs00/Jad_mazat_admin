(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ckeditor/ckeditor5-watchdog/src/editorwatchdog'), require('@angular/core'), require('@angular/common'), require('@angular/forms'),require('@angular/core'),require('@angular/forms'),require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@ckeditor/ckeditor5-angular', ['exports', '@ckeditor/ckeditor5-watchdog/src/editorwatchdog', '@angular/core', '@angular/common', '@angular/forms','@angular/core','@angular/forms','@angular/common'], factory) :
    (factory((global.ckeditor = global.ckeditor || {}, global.ckeditor['ckeditor5-angular'] = {}),global.EditorWatchdog,global.ng.core,global.ng.common,global.ng.forms,global.ng.core,global.ng.forms,global.ng.common));
}(this, (function (exports,EditorWatchdog,core,common,forms,ɵngcc0,ɵngcc1,ɵngcc2) { 
...
CKEditorComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: CKEditorComponent, selectors: [["ckeditor"]], factory: function CKEditorComponent_Factory(t) { return new (t || CKEditorComponent)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(core.NgZone)); }, inputs: { config: "config", data: "data", tagName: "tagName", disabled: "disabled", editor: "editor", watchdog: "watchdog" }, outputs: { ready: "ready", change: "change", blur: "blur", focus: "focus", error: "error" }, features: [ɵngcc0.ɵɵProvidersFeature([
            {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CKEditorComponent, [{
    ...
    }], function () { return [{ type: core.ElementRef }, { type: core.NgZone }]; }, { config: [{
            type: core.Input
        }], data: [{
            type: core.Input
        }], tagName: [{
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(CKEditorModule, { declarations: [CKEditorComponent], imports: [ɵngcc1.FormsModule, ɵngcc2.CommonModule], exports: [CKEditorComponent] });
...
CKEditorModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function CKEditorModule_Factory(t) { return new (t || CKEditorModule)(); }, imports: [[forms.FormsModule, common.CommonModule]] });
