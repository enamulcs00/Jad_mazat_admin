...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(FusionChartsComponent, [{
    ...
    }], function () { return [{ type: ElementRef }, { type: FusionChartsService }, { type: KeyValueDiffers }, { type: NgZone }]; }, { differs: [], zone: [], eventList: [], beforeLinkedItemOpen: [{
            type: Output
        }], linkedItemOpened: [{
            type: Output
