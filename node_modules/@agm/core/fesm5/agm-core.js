...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(KmlLayerManager, [{
        type: Injectable
    }], function () { return [{ type: GoogleMapsAPIWrapper }, { type: NgZone }]; }, { _wrapper: [], _zone: [], _layers: [], addKmlLayer: [], setOptions: [], deleteKmlLayer: [], createEventObservable: [] });
