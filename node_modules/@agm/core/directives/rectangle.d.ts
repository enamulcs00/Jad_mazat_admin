...
export declare class AgmRectangle implements OnInit, OnChanges, OnDestroy {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<AgmRectangle, "agm-rectangle", never, { 'clickable': "clickable", 'draggable': "rectangleDraggable", 'editable': "editable", 'strokePosition': "strokePosition", 'strokeWeight': "strokeWeight", 'visible': "visible", 'north': "north", 'east': "east", 'south': "south", 'west': "west", 'fillColor': "fillColor", 'fillOpacity': "fillOpacity", 'strokeColor': "strokeColor", 'strokeOpacity': "strokeOpacity", 'zIndex': "zIndex" }, { 'boundsChange': "boundsChange", 'rectangleClick': "rectangleClick", 'rectangleDblClick': "rectangleDblClick", 'drag': "drag", 'dragEnd': "dragEnd", 'dragStart': "dragStart", 'mouseDown': "mouseDown", 'mouseMove': "mouseMove", 'mouseOut': "mouseOut", 'mouseOver': "mouseOver", 'mouseUp': "mouseUp", 'rightClick': "rightClick" }, never>;
}
