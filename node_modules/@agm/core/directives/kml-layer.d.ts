...
export declare class AgmKmlLayer implements OnInit, OnDestroy, OnChanges {
    ...
    /** @internal */
    ngOnDestroy(): void;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<AgmKmlLayer, "agm-kml-layer", never, { 'clickable': "clickable", 'preserveViewport': "preserveViewport", 'screenOverlays': "screenOverlays", 'suppressInfoWindows': "suppressInfoWindows", 'url': "url", 'zIndex': "zIndex" }, { 'layerClick': "layerClick", 'defaultViewportChange': "defaultViewportChange", 'statusChange': "statusChange" }, never>;
}
