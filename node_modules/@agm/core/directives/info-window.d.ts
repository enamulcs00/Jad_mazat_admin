...
export declare class AgmInfoWindow implements OnDestroy, OnChanges, OnInit {
    ...
    /** @internal */
    ngOnDestroy(): void;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<AgmInfoWindow, "agm-info-window", never, { 'isOpen': "isOpen", 'latitude': "latitude", 'longitude': "longitude", 'disableAutoPan': "disableAutoPan", 'zIndex': "zIndex", 'maxWidth': "maxWidth" }, { 'infoWindowClose': "infoWindowClose" }, never>;
}
