...
export declare class AgmPolylineIcon implements OnInit {
    ...
    strokeWeight: number;
    ngOnInit(): void;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<AgmPolylineIcon, "agm-polyline agm-icon-sequence", never, { 'fixedRotation': "fixedRotation", 'offset': "offset", 'repeat': "repeat", 'anchorX': "anchorX", 'anchorY': "anchorY", 'fillColor': "fillColor", 'fillOpacity': "fillOpacity", 'path': "path", 'rotation': "rotation", 'scale': "scale", 'strokeColor': "strokeColor", 'strokeOpacity': "strokeOpacity", 'strokeWeight': "strokeWeight" }, {}, never>;
}
