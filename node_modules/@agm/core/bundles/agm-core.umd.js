(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@agm/core', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/common','@angular/core'], factory) :
...
}(this, function (exports, core, rxjs, operators, common,ɵngcc0) { 
const _c0 = [1, "agm-info-window-content"];
const _c1 = ["*"];
const _c2 = [1, "agm-map-container-inner", "sebm-google-map-container-inner"];
const _c3 = [1, "agm-map-content"];
'use strict';
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(GoogleMapsAPIWrapper, [{
        type: Injectable
    }], function () { return [{ type: MapsAPILoader }, { type: core.NgZone }]; }, { _loader: [], _zone: [], _map: [], createMap: [], setMapOptions: [], createMarker: [], createInfoWindow: [], createCircle: [], createRectangle: [], createPolyline: [], createPolygon: [], createDataLayer: [], createTransitLayer: [], createBicyclingLayer: [], containsLocation: [], subscribeToMapEvent: [], clearInstanceListeners: [], setCenter: [], getZoom: [], getBounds: [], getMapTypeId: [], setZoom: [], getCenter: [], panTo: [], panBy: [], fitBounds: [], panToBounds: [], getNativeMap: [], triggerMapEvent: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CircleManager, [{
        type: Injectable
    }], function () { return [{ type: GoogleMapsAPIWrapper }, { type: core.NgZone }]; }, { _apiWrapper: [], _zone: [], _circles: [], addCircle: [], removeCircle: [], setOptions: [], getBounds: [], getCenter: [], getRadius: [], setCenter: [], setEditable: [], setDraggable: [], setVisible: [], setRadius: [], getNativeCircle: [], createEventObservable: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PolygonManager, [{
        type: Injectable
    }], function () { return [{ type: GoogleMapsAPIWrapper }, { type: core.NgZone }]; }, { _mapsWrapper: [], _zone: [], _polygons: [], addPolygon: [], updatePolygon: [], setPolygonOptions: [], deletePolygon: [], getPath: [], getPaths: [], createEventObservable: [], createPathEventObservable: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PolylineManager, [{
        type: Injectable
    }], function () { return [{ type: GoogleMapsAPIWrapper }, { type: core.NgZone }]; }, { _mapsWrapper: [], _zone: [], _polylines: [], addPolyline: [], updatePolylinePoints: [], updateIconSequences: [], setPolylineOptions: [], deletePolyline: [], getMVCPath: [], getPath: [], createEventObservable: [], createPathEventObservable: [] });
...
AgmMap.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: AgmMap, selectors: [["agm-map"]], factory: function AgmMap_Factory(t) { return new (t || AgmMap)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(GoogleMapsAPIWrapper), ɵngcc0.ɵɵdirectiveInject(core.PLATFORM_ID), ɵngcc0.ɵɵdirectiveInject(FitBoundsService), ɵngcc0.ɵɵdirectiveInject(core.NgZone)); }, hostBindings: function AgmMap_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵstylingApply();
            ...
            PolylineManager,
            RectangleManager,
        ]), ɵngcc0.ɵɵNgOnChangesFeature()], ngContentSelectors: _c1, consts: 3, vars: 0, template: function AgmMap_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵelement(0, "div", _c2);
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AgmMap, [{
        ...
        args: [{
            ...
            }] }, { type: FitBoundsService }, { type: core.NgZone }]; }, { _elem: [], _mapsWrapper: [], _platformId: [], _fitBoundsService: [], _zone: [], longitude: [{
            type: Input
        }], latitude: [{
            type: Input
        }], zoom: [{
...
LazyMapsAPILoader.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: LazyMapsAPILoader, factory: function LazyMapsAPILoader_Factory(t) { return new (t || LazyMapsAPILoader)(ɵngcc0.ɵɵinject(LAZY_MAPS_API_CONFIG, 8), ɵngcc0.ɵɵinject(WindowRef), ɵngcc0.ɵɵinject(DocumentRef), ɵngcc0.ɵɵinject(core.LOCALE_ID)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(LazyMapsAPILoader, [{
        type: Injectable
                ...
                type: core.Inject,
                args: [core.LOCALE_ID]
            }] }]; }, { load: [], _assignScriptLoadingPromise: [], _scriptLoadingPromise: [], _getScriptSrc: [] });
